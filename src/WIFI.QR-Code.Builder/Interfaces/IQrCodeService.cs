...
namespace WIFI.QRCode.Builder.Interfaces;
...
public interface IQrCodeService
{
  ...
  BitmapSource CreateBitmapImage(QrCode qrCode, int moduleSize, int borderWidth = 3);
  ...
  DrawingImage CreateDrawing(QrCode qrCode, double size, int borderWidth = 3);
}
